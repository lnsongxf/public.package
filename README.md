...
We prepared a notebook to illustrate the typical workflow. It is available [online](http://nbviewer.ipython.org/github/grmToolbox/public.package/blob/master/lecture/package.ipynb).
